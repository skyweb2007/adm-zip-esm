...
class Utils {
    ...
    static methodToString(/*Number*/ method) {
        switch (method) {
    ...
    static sanitize(/*string*/ prefix, /*string*/ name) {
    ...
    static toBuffer(/*buffer, Uint8Array, string*/ input, /* function */ encoder) {
    ...
    writeFileTo(/*String*/ path, /*Buffer*/ content, /*Boolean*/ overwrite, /*Number*/ attr) {
        const self = this
    ...
    writeFileToAsync(/*String*/ path, /*Buffer*/ content, /*Boolean*/ overwrite, /*Number*/ attr, /*Function*/ callback) {
